...
### Steps
1. Lock in regressions with new E2E tests in [e2e/fs_ui_reactivity_test.cljs](e2e/fs_ui_reactivity_test.cljs) and [e2e/fs_write_test.cljs](e2e/fs_write_test.cljs) for: cancel-on-change, badge count, promise rejection.
